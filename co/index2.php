...
<body><center>
<div class="title">Answer the questions caefully and accurately.</div>
<?php                               
...
<tr><td><h3><br><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 6){ ?>
 ...
 if($no =="1"){
  ?>
  <p>There is nothing to worry about. You can for your own safety,
    <ul>
      <li>Stay at home.</li>
  ...
  <a href="2.html">Link</a><?php
 }
 if($no >"3"){?>
  <a href="3.html">Link</a><?php
 } ?>
